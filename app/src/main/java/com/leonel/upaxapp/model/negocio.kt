...
data class negocio (
                    ...
                    @SerializedName("numero_exterior") val numero_exterior: String,
                    @SerializedName("numero_interior") val numero_interior: String,
                    ...
                    @SerializedName("nombreColonia") val nombreColonia: String,
